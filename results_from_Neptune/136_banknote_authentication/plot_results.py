...
plt.plot(t, best,color='b',
         label='NN_1: {20:Tanh, 20:Tanh, 30:ReLU, 15:ReLU}',linestyle =None )
plt.plot(t, second_best, color='r', 
         label='NN_2: {30:Tanh, 15:ReLu, 30:ReLU, 30:ReLU, 15:ReLU}',  linestyle = '--', )
plt.plot(t, third_best,  color='g', 
         label='NN_3: {30:Hermite, 20:Tanh, 30:ReLU, 30:ReLU, 30:ReLU,}',  linestyle = 'dotted',)


# Naming the x-axis, y-axis and the whole graph
plt.ylabel("Validation Accuracy")
plt.xlabel("Number of epochs")
title = plt.title("Banknote Authentication: Performance of the 3 best models on the test data")
