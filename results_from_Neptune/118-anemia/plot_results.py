...
plt.plot(t, best,color='b',
         label='NN_1: {30:ReLU, 25:Hermite,25:ReLU,5:ReLU,20:ReLU}',linestyle =None )
plt.plot(t, second_best, color='r', 
         label='NN_2: {30:ReLU,20:Hermite,20:ReLU,5:ReLU,5:Tanh}',  linestyle = '--', )
plt.plot(t, third_best,  color='g', 
         label='NN_3: {30:ReLU,25:Hermite,30:ReLU,5:ReLU,5:Hermitte}',  linestyle = 'dotted',)


# Naming the x-axis, y-axis and the whole graph
plt.ylabel("Validation Accuracy")
plt.xlabel("Number of epochs")
title = plt.title("Anemia: Performance of the 3 best models on the test data")
