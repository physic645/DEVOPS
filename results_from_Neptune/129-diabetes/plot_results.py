...
plt.plot(t, best,color='b',
         label='NN_1: {5:ReLU, 15:Tanh,30:Hermite,5:ReLU,5:ReLU}',linestyle =None )
plt.plot(t, second_best, color='r', 
         label='NN_2: {15:ReLU,30:ReLU,5:Hermite,30:Tanh,30:Hermitte}',  linestyle = '--', )
plt.plot(t, third_best,  color='g', 
         label='NN_3: {15:ReLU,30:ReLU,5:Hermite,30:Tanh,30:Hermitte}',  linestyle = 'dotted',)


# Naming the x-axis, y-axis and the whole graph
plt.ylabel("Validation Accuracy")
plt.xlabel("Number of epochs")
title = plt.title("Diabetes: Performance of the 3 best models on the test data")
