...
plt.plot(t, best,color='b',
         label='NN_1: {30:ReLU, 5:Hermite,10:ReLU,20:ReLU,30:Tanh}',linestyle =None )
plt.plot(t, second_best, color='r', 
         label='NN_2: {30:ReLU,20:Hermite,15:ReLU,30:ReLU,5:Hermite}',  linestyle = '--', )
plt.plot(t, third_best,  color='g', 
         label='NN_3: {30:ReLU,5:Hermite,10:ReLU,25:ReLU,30:ReLU}',  linestyle = 'dotted',)


# Naming the x-axis, y-axis and the whole graph
plt.ylabel("Validation Accuracy")
plt.xlabel("Number of epochs")
title = plt.title("Surgical: Performance of the 3 best models on the test data")
