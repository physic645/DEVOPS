...
plt.plot(t, best,color='b',
         label='NN_1: {5:Hermite, 30:Hermite, 30:ReLU, 5:ReLU, 5:ReLU}',linestyle =None )
plt.plot(t, second_best, color='r', 
         label='NN_2: {5:Hermite, 30:Hermite, 30:ReLU, 5:ReLU, 25:Hermite}',  linestyle = '--', )
plt.plot(t, third_best,  color='g', 
         label='NN_3: {30:Hermite, 30:Hermite, 30:ReLU, 5:ReLU, 25:ReLU,}',  linestyle = 'dotted',)


# Naming the x-axis, y-axis and the whole graph
plt.ylabel("Validation Accuracy")
plt.xlabel("Number of epochs")
title = plt.title("Brain Tumor: Performance of the 3 best models on the test data")
