...
plt.plot(t, best,color='b',
         label='NN_1: {20:ReLU, 30:Tanh, 5:Tanh, 5:ReLU, 15:ReLU}',linestyle =None )
plt.plot(t, second_best, color='r', 
         label='NN_2: {10:ReLU, 30:ReLu, 30:ReLU, 5:ReLU, 20:ReLU}',  linestyle = '--', )
plt.plot(t, third_best,  color='g', 
         label='NN_3: {5:ReLU, 15:ReLU, 15:ReLU, 5:ReLU, 5:Hermite,}',  linestyle = 'dotted',)


# Naming the x-axis, y-axis and the whole graph
plt.ylabel("Validation Accuracy")
plt.xlabel("Number of epochs")
title = plt.title("Ionosphere: Performance of the 3 best models on the test data")
