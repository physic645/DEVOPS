...
plt.plot(t, best,color='b',
         label='NN_1: {30:ReLU, 30:ReLU, 25:ReLU, 5:Tanh, 5:Tanh}',linestyle =None )
plt.plot(t, second_best, color='r', 
         label='NN_2: {25:ReLU, 30:ReLU, 20:ReLU, 5:Tanh, 5:ReLU}',  linestyle = '--', )
plt.plot(t, third_best,  color='g', 
         label='NN_3: {25:ReLU, 30:Tanh, 25:ReLU, 5:Tanh, 5:Tanh,}',  linestyle = 'dotted',)


# Naming the x-axis, y-axis and the whole graph
plt.ylabel("Validation Accuracy")
plt.xlabel("Number of epochs")
title = plt.title("Phising Website: Performance of the 3 best models on the test data")
